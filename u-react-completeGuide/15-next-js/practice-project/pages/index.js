  ...
  return (
    <Fragment>
        <Head>
            ...
            <meta name="description" content="This test will appear as description in the browser results"/>
        </Head>
      <MeetupLis meetups={props.meetups} />
    </Fragment>
  );
}
...
export async function getStaticProps() {
  ...
  const client = await MongoClient.connect(
    "mongodb+srv://<username>:<password>@cluster0.kvz0sgn.mongodb.net/<collection>?retryWrites=true&w=majority"
  ); //replace <> values
  const db = client.db();
  ...
  return {
    props: {
      //this props are the props teh component receives
